...
--
-- Host: 127.0.0.1
-- Generation Time: May 22, 2026 at 07:08 PM
...
(52, 51, 87.98, 8.50, 13.50, 'Absent', NULL, 'Normal', '2026-05-21', 23, NULL, 'baseline', 1, '2026-05-21 05:07:33', 'Underweight', 'Normal', 'Severely Wasted', 29, 0);
...
(51, 'Angela', 'Reyes', 'Santos', '2024-06-21', 'Female', 'Aniban II, Bacoor', 'Catholic', '', '', '2026-05-20 20:49:40', 21, 'CH-7934', 0);
...
(4, 'Parent Meeting', 'I hope na magkaroon ng time ang bawat parents na makapunta sa gaganapin na meeting.', 'Meeting', '2026-05-21', '10:00:00', '11:30:00', 'CityHall', 'Upcoming', 1, '2026-05-20 21:12:46', NULL, 0);
...
(54, 51, 52, 50, 'Severely Wasted', 'Severely Wasted', 'Ensure the child eats every meal on time (never skip meals)\nGive small but frequent meals throughout the day\nEnsure adequate water intake daily\nMonitor closely for weakness or signs of illness\nSeek immediate care if the child becomes very weak or condition worsens', 'kumain ng masustansyang pagkain', 0, 0, 0, 1, 1, 1, '2026-05-21 05:09:44', 'Generated from latest submitted WMR', '2026-05-20 21:09:44', '2026-05-20 21:09:44', NULL, 0);
...
(9, 29, 5, 'WMR baseline', 'BASELINE IS REALLY NEEDED', '2026-05-21', 1, '2026-05-21 05:13:53', '2026-05-20 21:13:26', 0, NULL);
...
(1, 1, 'Admin', 'User', 'admin@gmail.com', '1234', NULL, NULL, '2026-03-25 22:04:10', '2026-05-21 05:14:07'),
(29, 2, 'Anna', 'Natividad', 'annanatividad@gmail.com', 'annanatividad', '09285567789', 'Aniban II, Bacoor', '2026-05-20 20:42:46', '2026-05-21 05:13:53'),
(30, 3, 'Michelle', 'Santos', 'michellesantos@gmail.com', 'michellesantos', NULL, NULL, '2026-05-20 20:56:04', '2026-05-21 05:14:48');
...
--
ALTER TABLE `cdc`
  MODIFY `cdc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `child_health_information`
  MODIFY `health_info_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `deworming_records`
  MODIFY `deworm_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `feeding_records`
  MODIFY `feeding_record_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=132;

--
-- AUTO_INCREMENT for table `feeding_record_items`
--
ALTER TABLE `feeding_record_items`
  MODIFY `feeding_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=491;
...
--
ALTER TABLE `intervention_guidance`
  MODIFY `guidance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT for table `milk_feeding_records`
--
ALTER TABLE `milk_feeding_records`
  MODIFY `milk_record_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;
...
--
ALTER TABLE `reminder_targets`
  MODIFY `reminder_target_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `submitted_reports`
  MODIFY `submitted_report_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
